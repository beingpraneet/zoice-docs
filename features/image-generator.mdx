...
2. **Reference Image (Optional)**: Upload an image to guide the AI's generation (Note: Supported in select models)
3. **Select a Model**: Choose the AI model that best fits your needs
4. **Customize Settings**: Adjust resolution, style, and other parameters
5. **Generate**: Click generate and watch your image come to life
6. **Download**: Save your creation in high quality

## Getting Started

<Steps>
  <Step title="Navigate to New Image">
  ...
  <Step title="Write Prompt or Upload Reference">
    ...
    <Frame>
      ![Write Prompt or Upload Reference](../images/write-prompt-or-upload-reference.png)
    </Frame>
  </Step>
