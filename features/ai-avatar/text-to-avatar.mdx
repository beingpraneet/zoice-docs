...
description: Create custom AI avatars from text descriptions with full control over appearance and style.
---

## Overview

The Text-to-Avatar feature allows you to generate unique AI avatars from scratch using text descriptions. Simply describe the avatar you want, and Zoice will create a realistic digital character that can speak and present content.
