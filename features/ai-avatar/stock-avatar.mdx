---
title: Stock Avatar
description: Choose from Zoice's library of professional AI avatars to create video presentations quickly. Stock avatars are pre-made, diverse characters ready to deliver your message without the need for custom creation or photo uploads.
---
...
<Steps>
  ...
  <Step title="Select Voice Over & AI Model">
    Choose the perfect voice and AI model to bring your avatar to life.
    <Frame>
      ![Select Voice and Model](../../images/select-voice-over-model.png)
    </Frame>
  </Step>
