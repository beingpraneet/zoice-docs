...
description: Generate natural, human-like AI voices from text. Build high-quality narration for videos, podcasts, and e-learning with Zoice's text-to-speech engine.
---
...
<CardGroup cols={2}>
  <Card title="Text-to-Voice Guide" icon="text" href="/zoice-tools/voice-generator/text-to-voice">
    Detailed steps for creating professional narration from text.
  </Card>
  <Card title="AI Avatar Generator" icon="user-tie" href="/features/ai-avatar/stock-avatar">
    Combine AI voices with animated characters for high-impact video.
  </Card>
  <Card title="Video to Text" icon="file-audio" href="/zoice-tools/transcribe/video-to-text">
    Transcribe your existing videos into accurate text descriptions.
  </Card>
  <Card title="Prompt Guide" icon="lightbulb" href="/prompt-guide/introduction">
    Master effective prompting for better AI voice results.
  </Card>
</CardGroup>
