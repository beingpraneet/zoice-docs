...
description: Create unique AI avatars from scratch using text descriptions. Design custom characters with specific appearances, styles, and personalities for your video content without needing photos or images.
---

## What are Text to Avatars?

Text to Avatars allows you to describe your ideal presenter using text prompts, and our AI will generate a 3D avatar model matching your description. You have full control over appearance, style, clothing, and characteristics.

## Benefits of Text to Avatars

- **Total Control**: Design every aspect of your character's appearance
- **Brand Representation**: Create a unique face for your brand
- **No Photo Needed**: Generate professional avatars without personal images
- **Creative Freedom**: Experiment with diverse styles and personalities
- **Consistency**: Maintain the same character across multiple projects
...
<Steps>
  ...
  <Step title="Generate HD Image">
    Write a detailed text prompt to have AI generate a high-definition image for your avatar's base appearance.
    <Frame>
      ![Generate HD Image](../../images/generate-hd-image.png)
    </Frame>
  </Step>
  ...
  <Step title="Click on Generate Avatar">
    Once you've generated your image, click on **Generate Avatar**. You will now see your avatar saved in your gallery.
    <Frame>
      ![Generate Avatar](../../images/generate-avatar-gallery.png)
    </Frame>
  </Step>
  ...
  <Step title="Go Back to New Avatar Section and Select Custom Avatar">
    ...
    - **Add Voice**: Select a voice or upload your own 1-minute voice sample if preferred.
    <Frame>
