...
description: Create smooth videos from frame-by-frame image sequences with AI interpolation.
---

## Overview

Frame-to-Video converts sequences of individual frames into smooth, fluid video. Upload keyframes and let AI generate the in-between frames, creating seamless animations perfect for stop-motion, animation, or precise video control.
...
<Steps>
  <Step title="Upload Keyframes">
    Upload 2-20 keyframe images in sequence
  </Step>
  <Step title="Set Frame Rate">
    Choose target frame rate (24, 30, or 60 fps)
  </Step>
  <Step title="Configure Interpolation">
    Set smoothness and interpolation strength
  </Step>
  <Step title="Preview">
    Check the frame sequence
  </Step>
  <Step title="Generate">
