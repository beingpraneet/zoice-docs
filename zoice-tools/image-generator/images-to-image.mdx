...
description: Transform and modify existing images using AI-powered image-to-image generation.
---
...
<Steps>
  <Step title="Upload Image">
    Select and upload your reference image
  </Step>
  <Step title="Write Transformation Prompt">
    Describe how you want to modify the image
  </Step>
  <Step title="Adjust Strength">
    Set how much the AI should transform the image
  </Step>
  <Step title="Select Model">
    Choose the appropriate AI model
  </Step>
  <Step title="Generate">
    Create your transformed image
  </Step>
  <Step title="Download">
    Save the result
  </Step>
