---
title: Video to Text
description: Transcribe videos into accurate text with timestamps and speaker identification.
---

## Overview

Video-to-Text transcription converts spoken content in videos into written text. Perfect for creating subtitles, captions, transcripts, or making video content searchable and accessible.

## Quick Start

<Steps>
  <Step title="Upload Video">
    Select the video file you want to transcribe
  </Step>
  <Step title="Select Language">
    Choose the primary language spoken in the video
  </Step>
  <Step title="Configure Options">
    Set timestamp format, speaker detection, and output format
  </Step>
  <Step title="Start Transcription">
    Begin the transcription process
  </Step>
  <Step title="Review & Edit">
    Check and edit the generated transcript
  </Step>
  <Step title="Export">
...
<CardGroup cols={2}>
  ...
  <Card title="Voice Generator" icon="volume-high" href="/features/voice-generator">
