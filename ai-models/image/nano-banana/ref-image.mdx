---
title: Image-to-Image with Nano Banana
description: Create AI images using reference photos with the Nano Banana model. Learn how to control influence strength for consistent style and composition transformations.
---
